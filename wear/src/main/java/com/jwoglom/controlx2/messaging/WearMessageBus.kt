...
/**
 * Wear OS implementation of MessageBus for watch app.
 * Always uses Google Wearable Data Layer API since watches require Wear OS.
 */
class WearMessageBus(private val context: Context) : MessageBus, MessageClient.OnMessageReceivedListener {
    ...
    init {
        Timber.d("WearMessageBus (watch) initialized")
    ...
    override fun close() {
        Timber.d("WearMessageBus (watch).close()")
